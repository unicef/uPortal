...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
	...
	<div class="content-desc-title-wrapper">
		...
		<div class="content-desc-wrapper clearfix">
			...
			<div class="content-player" data-document-url="<?php print $pdf_path ?>">
...
<div id="pdf-reader">
	<iframe webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" frameborder="no" height="100%" width="100%" src="/sites/all/libraries/pdf.js/web/viewer.html?file="></iframe>
