...
$images_results = views_get_view_result('content_index', $images_view, $series_plan_nid);
$images = array();
$img_str = '';
...
//$ugyouthportal_data['dsm_fields'] = array ( 'images' => $images_results, 'the-series-nid'=>$series_plan_nid, );
